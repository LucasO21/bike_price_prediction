...
bikes_tbl <- read_rds("../app_data/bikes_data_clean_tbl.rds") %>% 
  ...
  filter(!model_name == "Supercaliber 9.9 XX1 ASX") %>% 
...
renderPrint({
  ...
  dir_files <- fs::dir_ls("product_img/")
...
# renderPrint({
#    detect_product_id <- new_bike_pred_tbl() %>% pull(product_id) %>% glimpse()
# })
...
# 
#   # detect_product_id = "37420"
# 
#   path <- paste0("bike_img/product_id_", "37420", ".png")
# 
#   list(
#     src         = path,
#     contentType = "image/png",
...
#   }, deleteFile = FALSE )
# 
# imageOutput("bikeImage")

# knitr::include_graphics("bike_img/product_id_17027.jpg")
# eventReactive(eventExpr = input$apply, valueExpr = {
#
#   new_bike_pred_tbl %>% pull(product_id)
#
# }, ignoreNULL = FALSE)


#knitr::include_graphics("product_id_37420.jpg")

# knitr::include_graphics("bike_img/product_id_17027.jpg")

# id <- "33085"
# 
# knitr::include_graphics(paste0("bike_img/product_id_", id, ".jpg"))

# output$id <- reactive ({
#   
#   #knitr::include_graphics(paste0("bike_img/product_id_", new_bike_pred_tbl() %>% pull(product_id), ".jpg"))
#   
#   new_bike_pred_tbl() %>% pull(product_id)
#   
#   # knitr::include_graphics(paste0("bike_img/product_id_", id, ".jpg"))
